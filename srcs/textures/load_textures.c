...
void load_player(t_game *game)
{
    ...
    game->player_shoot.frames = load_n_images(game, "Gun/gun", game->player_shoot.frameNum);
...
static int load_textures_to_mlx(t_game *game, t_settings *map_settings)
{
    ...
    load_player(game);
    if ((game->texture_wall.n.img == NULL) || (game->texture_wall.s.img == NULL) || (game->texture_wall.w.img == NULL) || (game->texture_wall.e.img == NULL) || (game->texture_door.img == NULL))
